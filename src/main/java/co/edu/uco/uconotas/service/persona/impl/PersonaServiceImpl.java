...
public class PersonaServiceImpl implements PersonaService {
    ...
    @Override
    public Persona findByNroDocumentoContaining(String nroDocumento) {
        return converter.entityToModel(personaRepository.findByNroDocumentoContaining(nroDocumento));
    }
    ...
    public void update(Persona persona) {
        personaRepository.save(converter.modelToEntityUpdate(persona));
    }
}
