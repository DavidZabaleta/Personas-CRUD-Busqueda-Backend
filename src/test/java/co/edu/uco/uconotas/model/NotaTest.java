...
import co.edu.uco.uconotas.model.message.Mensaje;
...
public class NotaTest {
    ...
    @Test
    public void insertarNotasMayorPermitida() throws ValorMaximoPermitidoException, NotaMinimaPermitidaException{
    ...
    @Test
    public void insertarNotaMinimaPermitida() throws ValorMaximoPermitidoException, NotaMinimaPermitidaException{
        exception.expect(NotaMinimaPermitidaException.class);
        exception.expectMessage(Mensaje.Nota.NOTA_MINIMA_NO_PERMITIDA);
